...
.project ul li{width:20px;height:20px;border:2px solid #2DCC70;display:inline-block;}
.project ul li.active{background-color:2DCC70;}
.project ul li:hover{background-color:2DCC70;}.our-team {
...
<p> Algorithm - datastructure - database - oop C++ -Java - SmallBasic - visual Basic -pascal - php</div>
</div>
<div class="content">
<div class="icon">
...
<div class="item">
  ...
  <div class="our-team" id="portfolio">
    <div class="main-title">
      <h2>Our Team</h2>
      <p>Aliquam at tortor sit amet eros bibendum faucibus quis nec arcu. Quisque lobortis lectus vitae lectus aliquet
        leo.</p>
    </div>
    <div class="container">
    <div class="box">
